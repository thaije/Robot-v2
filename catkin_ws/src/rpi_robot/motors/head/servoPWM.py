...
def initialize_default_servos():
    ...
    verticalServo = Servo(pin=13, minPos=600, maxPos=1750, centerPosition=800) # down up
    horizontalServo = Servo(pin=18, minPos=600, maxPos=2400, centerPosition=1500) # left right
