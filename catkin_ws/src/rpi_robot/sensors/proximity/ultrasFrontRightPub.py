...
def talker():
    pub = rospy.Publisher('ultrasonicRight', Range, queue_size=10)
    rospy.init_node('ultrasonicRight', anonymous=True)
    ...
    while not rospy.is_shutdown():
        ...
        ultr_str = "Ultrasonic front right distance %0.3f at time %s" % (range_msg.range, rospy.get_time())
