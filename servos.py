...
def initialize_default_servos():
    ...
    verticalServo = Servo(pin=13, minPos=55, maxPos=120, centerPosition=62)
    horizontalServo = Servo(pin=18, minPos=30, maxPos=115, centerPosition=72)
...
def approve():
    verticalServo.setPosition(70)
    sleep(0.3)
    verticalServo.setPosition(90)
    sleep(0.3)
    verticalServo.setPosition(70)
    sleep(0.3)
    verticalServo.setPosition(80)
    sleep(1.5)
